...
public class AddRooms extends JFrame implements ActionListener{
    ...
    AddRooms(){
        ...
        String cleanOptions[]={"Luxury", "Normal"};
     ...
     add = new JButton("Add Room");
      ...
      cancel = new JButton("Cancel");
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/interior.jpg"));
...
try {
    // Database ko operation haru
    Conn conn = new Conn();
    String str = "insert into room values('" + roomnumber + "', '"+availability+"','" + status + "','" + price + "','" +  type + "')"; //careful here
